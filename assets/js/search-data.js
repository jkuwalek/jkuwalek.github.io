      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "News",handler: () => {
              window.location.href = "/news/mainpage/announcement_2/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%61%6B%75%62.%6B%75%77%61%6C%65%6B@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/jkuwalek", "_blank");
        },
      },{
        id: 'social-kaggle',
        title: 'Kaggle',
        section: 'Socials',
        handler: () => {
          window.open("https://www.kaggle.com/jacobkuwalek", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/jkuwalek", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
